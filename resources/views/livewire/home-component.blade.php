        ...
        @foreach ($sliders as $slide)
          <div class="item-slide">
                ...
                <div class="slide-info slide-1">
                  ...
                  <p class="sale-info">Only price: <span class="price">PHP {{$slide->price}}</span></p>
    ...
    <div class="wrap-banner style-twin-default">
      <div class="banner-item">
        <a href="/shop" class="link-banner banner-effect-1">
          <figure><img src="{{ asset('assets/images/home_1_banner.jpg') }}" alt="" width="580" height="190"></figure>
        </a>
      </div>
      <div class="banner-item">
        <a href="/shop" class="link-banner banner-effect-1">
        ...
        <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
          ...
          <div class="product product-style-2 equal-elem ">
            ...
            <div class="product-info">
              ...
              <div class="wrap-price"><ins><p class="product-price">PHP {{$sproduct->sale_price}}</p></ins> <del><p class="product-price">PHP {{$sproduct->regular_price}}</p></del></div>
            </div>
          </div>
          @endforeach
        </div>
                ...
                @foreach ($lproducts as $lproduct)
                  <div class="product product-style-2 equal-elem ">
                    ...
                    <div class="product-info">
                      ...
                      <div class="wrap-price"><span class="product-price">PHP {{$lproduct->regular_price}}</span></div>
                    </div>
                  </div>
                @endforeach
              </div>
        ...
        <div class="wrap-product-tab tab-style-1">
          ...
          <div class="tab-contents">
            ...
            <div class="tab-content-item {{$key==0 ? 'active':''}}" id="category_{{$category->id}}">
              <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
                @php
                  $c_products = DB::table('products')->where('category_id',$category->id)->get()->take($no__of_products);
                @endphp
