<main id="main" class="main-site">
  <style>
    .summary-item .row-in-form input[type="password"], .summary-item .row-in-form input[type="text"], .summary-item
    .row-in-form input[type="tel"] {
      font-size: 13px;
      line-height: 19px;
            ...
            <div class="wrap-address-billing">
              ...
              <div class="billing-address">
                ...
                <p class="row-in-form">
                  ...
                  <input type="text" name="country" value="" placeholder="Philippines" wire:model="country">
        ...
        <div class="summary summary-checkout">
          <div class="summary-item payment-method">
            ...
            @if (Session::has('checkout'))
              <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">PHP.{{Session::get('checkout')['total']}}</span></p>
            @endif
