            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    @if (Session::has('coupon'))
                        <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}}) <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a> </span><b class="index"> -PHP.{{number_format($discount)}}</b></p>
                        <p class="summary-info"><span class="title">Subtotal with discount</span><b class="index">PHP. {{number_format($subtotalAfterDiscount,2)}} </b></p>
                        <p class="summary-info"><span class="title">Tax ({{config('cart.tax')}}%)</span><b class="index">PHP. {{number_format($taxAfterDiscount,2)}} </b></p>
                        <p class="summary-info total-info "><span class="title">Total</span><b class="index">PHP. {{number_format($totalAfterDiscount,2)}} </b></p>
                    @else
